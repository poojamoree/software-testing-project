...
public class Automation_Project 
{
	...
	public static void main(String[] args) throws InterruptedException, IOException 
	{
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\OM\\Desktop\\selenium jar\\chromedriver.exe");
       ...
       //screenshot
        ...
        Files.copy(src, new File("F:\\Screenshot\\submit1.jpg"));
        Thread.sleep(2000);
       ...
       //checkbox         
        ...
        Files.copy(src96, new File("F:\\Screenshot\\submit.jpg"));
        ...
        Files.copy(src91, new File("F:\\Screenshot\\radio.jpg"));
       ...
       //Web tables 
        ...
        Files.copy(src97, new File("F:\\Screenshot\\submit.jpg"));
        ...
        Files.copy(src92, new File("F:\\Screenshot\\submit.jpg"));
        ...
        Files.copy(src1, new File("F:\\Screenshot\\submit1.jpg"));
        ...
        Files.copy(src93, new File("F:\\Screenshot\\submit.jpg"));
        ...
        w.findElement(By.id("uploadFile")).sendKeys("C:\\Users\\OM\\Desktop\\AxisBank.xlsx");
        ...
        Files.copy(src94, new File("F:\\Screenshot\\submit.jpg"));
        ...
        Files.copy(src95, new File("F:\\Screenshot\\submit.jpg"));
		...
		w.findElement(By.xpath("//label[contains(text(),'Reading')]")).click();
		   w.findElement(By.id("uploadPicture")).sendKeys("C:\\Users\\OM\\Desktop\\Manual Project.xlsx");
        ...
        w.findElement(By.xpath("//div[contains(text(),'Haryana')]")).click();
	       ...
	       Files.copy(src11, new File("F:\\Screenshot\\form1.jpg"));
	    ...
	    TakesScreenshot t51 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc51, new File("F:\\Screenshot\\accordian.png"));
	   ...
	   //3nd option click and close	    
	    ...
	    TakesScreenshot t52 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc52, new File("F:\\Screenshot\\accordian.png"));
	    ...
	    Files.copy(srcc522, new File("F:\\Screenshot\\Autoomplete.png"));
	    ...
	    TakesScreenshot t56 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc56, new File("F:\\Screenshot\\Date.png"));
        ...
        TakesScreenshot t53 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc53, new File("F:\\Screenshot\\slider.png"));
		...
		TakesScreenshot t54 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc54, new File("F:\\Screenshot\\bar.png"));
	    ...
	    TakesScreenshot t55 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc55, new File("F:\\Screenshot\\tabs.png"));
	    ...
	    TakesScreenshot t91 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc91, new File("F:\\Screenshot\\menu.png"));
	    ...
	    TakesScreenshot t57 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc57, new File("F:\\Screenshot\\SMenu.png"));
      ...
      Files.copy(src5, new File("F:\\Screenshot\\vidya7.png"));
	  Thread.sleep(6000);
	 ...
	 //Take screenshot
      ...
      Files.copy(src6, new File("F:\\Screenshot\\vidya8.png"));
     ...
     //Grid       
      ...
      Files.copy(src2, new File("F:\\Screenshot\\vidya9.png"));
	  ...
	  //Grid	  
	   ...
	   Files.copy(src3, new File("F:\\Screenshot\\vidya10.png"));
	...
	//System.out.println("window is  scrolled ");
     ...
     Files.copy(src4, new File("F:\\Screenshot\\vidya11.png"));
	...
	//droppable 	 
      ...
      Files.copy(src7, new File("F:\\Screenshot\\vidya12.png"));
      ...
      Files.copy(src9, new File("F:\\Screenshot\\vidya13.png"));
	 ...
	 //cursorStyle	  
      ...
      Files.copy(srcc, new File("F:\\Screenshot\\vidya14.png"));
      ...
      w.navigate().refresh();
		...
		TakesScreenshot t77 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc66, new File("F:\\Screenshot\\vidya14.png"));
		...
		TakesScreenshot t71 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc71, new File("F:\\Screenshot\\vidya14.png"));
		...
		TakesScreenshot t72 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc72, new File("F:\\Screenshot\\vidya14.png"));
	   ...
	   //2nd Link 
		...
		TakesScreenshot t73 =(TakesScreenshot) w;
	      ...
	      Files.copy(srcc73, new File("F:\\Screenshot\\vidya14.png"));
	    ...
	    Files.copy(sr1cc, new File("F:\\Screenshot\\book.png"));
